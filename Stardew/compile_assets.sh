...
./build/atlastool/AtlasTool ./WfAssets/out/atlascombined.xml -o ./WfAssets/out/main.atlas -bmp Atlas.bmp -iw 1024 -ih 1024

# compile another atlas file containing sprites and fonts for the games UI 
./build/atlastool/AtlasTool ./WfAssets/ui_atlas.xml -o ./WfAssets/ui_atlas.atlas -bmp UIAtlas.bmp -iw 1024 -ih 1024
