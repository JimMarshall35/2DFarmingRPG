...
robocopy engine\src\%1 game\%1 "StardewEngine.dll" /E /XO
robocopy engine\src\%1 enginetest\%1 "StardewEngine.dll" /E /XO
robocopy "..\enginetest\data" enginetest\%1\data /E /XO
robocopy atlastool\%1 "../engine/scripts" "AtlasTool.exe" /E /XO
robocopy engine\src\%1 "../engine/scripts" "StardewEngine.dll" /E /XO
